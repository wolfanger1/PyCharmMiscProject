...
class LagerSimulation(ShowBase):
    ...
    def collision_avoidance_adjustment(self, current_vehicle, base_speed, safe_distance=3.0):
        """
        Prüft, ob ein anderes Fahrzeug innerhalb einer sicheren Distanz (safe_distance) ist.
        Reduziert die Geschwindigkeit mit einem quadratischen Faktor, sodass bei sehr kurzen
        Abständen die Geschwindigkeit drastisch sinkt.
        """
        ...
        for veh in self.garage_vehicles:
            ...
            if distance < safe_distance:
                # Quadratische Reduktion: Bei Abstand 0 wird die Geschwindigkeit 0, bei safe_distance
                # bleibt sie unverändert. Dadurch sinkt sie sehr schnell bei geringen Abständen.
